classdef ccSBATCH
    ...
    properties
        ...
        cpusPerTask = 15;   % To allow speedup on entire nodes
        gpusPerNode = 0;
        ...
        % e.g.
        otherOptions = '--mail-user=q2h3s6p4k0e9o7a5@biaptlab.slack.com --mail-type=ALL --job-name=make-feature'
