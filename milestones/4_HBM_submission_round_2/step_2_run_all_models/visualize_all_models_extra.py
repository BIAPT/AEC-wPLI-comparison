...
for s in Steps:
    ...
    for c in Cs:
        for k in kernels:
            first_last_pli = load_pickle(f"{IN_DIR}final_SVC_{k}_c_{c}_both_first_last_{s}.pickle")
            first_last_aec = load_pickle(f"{IN_DIR}final_SVC_{k}_c_{c}_both_first_last_{s}.pickle")
            first_last_both = load_pickle(f"{IN_DIR}final_SVC_{k}_c_{c}_both_first_last_{s}.pickle")
            resp_unres_pli = load_pickle(f"{IN_DIR}final_SVC_{k}_c_{c}_both_first_last_{s}.pickle")
            resp_unres_aec = load_pickle(f"{IN_DIR}final_SVC_{k}_c_{c}_both_first_last_{s}.pickle")
            resp_unres_both = load_pickle(f"{IN_DIR}final_SVC_{k}_c_{c}_both_first_last_{s}.pickle")
