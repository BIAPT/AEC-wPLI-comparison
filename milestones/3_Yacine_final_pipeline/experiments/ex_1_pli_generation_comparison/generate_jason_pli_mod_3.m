%% Yacine Mahdid 15 Septembre 2020
% This is the way that Jason calculate pli with an improvement

%% Path Setup
% Local Source
%{
INPUT_DIR = "/media/yacine/My Book/datasets/consciousness/AEC vs wPLI/source localized data/";
OUTPUT_DIR = "/media/yacine/My Book/test_result/jason_graph_improved/";
%}

% Remote Source
%
INPUT_DIR = "/lustre03/project/6010672/yacine08/aec_vs_pli/data/source_localized_data/";
OUTPUT_DIR = "/lustre03/project/6010672/yacine08/aec_vs_pli/result/ex_1_pli_generation_comparison/jason_mod_3_graphs/";
...
function [PLIcorr] = surrogate_analysis_faulty(ht_win, pli_temp)
...
%Calculating the surrogate
    ...
    for j = 1:20
        PLI_surr(j,:,:) = w_PhaseLagIndex_surrogate(ht_win);
    end
